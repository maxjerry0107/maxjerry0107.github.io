...
!(function(t) {
  "use strict";
  function a() {
    t(".js-slick-test").each(function() {
      var a =
        t(this)
          .find(".client-avatar img")
          .offset().top - t(this).offset().top;
      t(this)
        .find(".arrow")
        .css("top", a);
    });
  ...
  e.each(function() {
    ...
    for (var e in i)
      i.hasOwnProperty(e) &&
        null != t(this).attr("data-slick-" + e) &&
        (i[e] = t(this).data("slick-" + e));
    i.thumb
      ? t(this).slick({
          ...
          arrows: i.arrows,
          asNavFor: i.asnavfor,
          appendArrows: i.appendarrows,
          appendDots: i.appenddots,
          prevArrow: i.prevarrow,
          nextArrow: i.nextarrow,
          centerMode: i.centermode,
          centerPadding: i.centerpadding,
          cssease: i.cssease,
          dots: i.dots,
          dotsClass: i.dotsclass,
      ...
      t(this).on("init", function() {
        a(t("div.hero-slide:first-child").find("[data-animation]"));
      }),
      t(this).on("beforeChange", function(i, e, n, o) {
        a(
          t(this)
            .find('[data-slick-index="' + o + '"]')
            .find("[data-animation]")
        );
      });
  }),
  ...
  s &&
    s.waypoint(
      function() {
        o ||
          ((o = !0),
          t(".au-progress .au-progress-bar").progressbar({
            update: function(t, a) {
              a.find(".value").html(t + "%");
            }
          }));
  ...
  var r = t(".js-header-bar, .js-header-bar-mobile"),
    d = t(".js-header-bar-mobile"),
    l = d.find(".navbar-primary"),
    c = d.find(".navbar-toggler"),
    h = r.offset().top;
  t(window).on("scroll", function() {
    t(this).scrollTop() > h ? r.addClass("sticky") : r.removeClass("sticky");
  });
  var p = r.find(".nav-link"),
    u = p.map(function() {
      var a = t(t(this).attr("href"));
  ...
  p.on("click", function(a) {
    ...
    r.hasClass("sticky")
      ? i.animate(
          {
            scrollTop: t(e.attr("href")).offset().top - r.outerHeight()
          },
          800
        )
      : r
    ...
    t(window).scroll(function() {
      var a = t(this).scrollTop() + r.outerHeight() + 15,
        i = u.map(function() {
          if (t(this).offset().top < a) return this;
        }),
        e = (i = i[i.length - 1]) && i.length ? i[0].id : "";
      p.parent()
        .removeClass("active")
        .end()
        .filter("[href='#" + e + "']")
    ...
    c.on("click", function(t) {
      l.slideToggle(), t.preventDefault();
    }),
    t('[data-toggle="tooltip"]').tooltip();
  var f = t(".js-modal").modal({
    backdrop: !1,
    show: !1
  });
  f.on("show.bs.modal", function() {
    t(this)
      .find(".modal-dialog")
      .attr("class", "modal-dialog  fadeIn  animated"),
      t(this)
        .find(".modal-primary")
        .hide();
  }),
    f.on("shown.bs.modal", function() {
      var a = t(this).find(".loader");
      a.show(),
        t(this)
          .find(".modal-primary")
          .delay(1e3)
          .fadeIn(500, function() {
            e.slick("setPosition"), a.hide();
          });
    }),
    f.on("hide.bs.modal", function() {
      t(this)
        .find(".modal-dialog")
        .attr("class", "modal-dialog  fadeOut  animated");
    }),
    a(),
  ...
  (t.fn.introSlider = function(a) {
    return (
      ...
      this.each(function(i, e) {
        var n = t(this);
        if ("fullscreen" == a.layout) {
          var o = t(window).height();
          n.height(o),
            t(window).width() >= 992 &&
              t(window).on("resize", function() {
                (o = t(window).height()), n.height(o);
              });
        }
        null != a.bg &&
          (n.css("background", "url(" + a.bg + ") center center no-repeat"),
          n.css("background-size", "cover")),
          (window.onload = function() {
            n.find("[data-intro-animate]").css("visibility", "hidden"),
              n.find("[data-intro-animate]").each(function() {
                var a = t(this).data("intro-animate"),
                  i = t(this).data("intro-delay");
                t(this)
                  .delay(i)
                  .queue(function(i) {
                    t(this).addClass(a),
    ...
    m.each(function() {
      ...
      for (var i in a)
        a.hasOwnProperty(i) &&
          null != t(this).attr("data-intro-" + i) &&
          (a[i] = t(this).data("intro-" + i));
      t(this).introSlider({
        layout: a.layout,
        bg: a.bg
      });
  ...
  v.hide(),
    t(window).on("scroll", function() {
      t(this).scrollTop() > 450 ? v.fadeIn(500) : v.fadeOut(500);
    }),
